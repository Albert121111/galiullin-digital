...
Портфолио начинающей digital-студии для малого бизнеса. Сайт показывает демо-кейсы решений: лендинги, формы заявок, онлайн-запись, калькулятор стоимости и простую автоматизацию.
...
В демо-кейсах формы работают без настоящего backend. В каждом client-компоненте есть функция-заглушка `sendLeadToTelegram`, которую можно заменить на реальную отправку в CRM или таблицу.
