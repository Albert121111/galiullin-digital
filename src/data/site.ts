...
export const services = [
  ...
  {
    title: "Формы для заявок",
    description:
      "Аккуратные формы, где клиент оставляет контакт, услугу, удобное время и комментарий.",
  },
  {
    title: "Автоматизация заявок",
    description:
      "Передача обращений в таблицы или CRM без ручного копирования данных.",
  },
  {
    title: "Онлайн-запись",
    description:
      "Простая запись на услугу, тренировку или визит без долгой переписки.",
  },
  {
...
export const projects: Project[] = [
  {
    ...
    tags: ["Лендинг", "Онлайн-запись", "Форма заявки"],
    href: "/cases/fitness",
...
export const workflow = [
  ...
  },
  {
    ...
    description:
      "Настраиваю формы, таблицы и простую логику обработки заявок.",
  },
  {
